...
subtitle: ""
excerpt: "How the targets package changed the way I write R code and run analyses"
date: 2023-02-04
...
The real fun began when I learned about Rmarkdown. At the time I was actually using Sweave, but that's a very similar experience. Not only could I write R code, but I could record any comments about the analysis and my interpretation of the results alongside the code in a single document. So efficient! Rmarkdown quickly became by default choice when writing any R code. During my PhD, I used several Rmarkdown notebooks to records the different steps of the (complex) analysis that I was working on. I started numbering my notebooks (`1_preprocessing.Rmd,` `2_normalisation.Rmd`, etc), and also saving them into different folders according to the analysis step (`Dataset_X_analysis`, `dataset_x_some_followup analysis`...).
